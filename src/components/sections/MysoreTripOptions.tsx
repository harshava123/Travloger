...
interface MysoreTripOptionsProps {
...
const mysoreTrips: TripCard[] = [
  ...
  {
    id: 'custom-1',
    title: 'Coorg & Mysore Adventure',
    description: 'Explore the coffee capital Coorg and royal Mysore with heritage sites and hill stations',
    image: '/cards/1.jpg',
    nights: 2,
    days: 3,
    price: 15999,
    category: 'custom',
    route: 'Mysore → Coorg → Golden Temple → Dubare',
    trending: true
  },
  {
    id: 'custom-2',
    title: 'Coorg Coffee Trail',
    description: 'Discover the aromatic coffee estates and waterfalls of Coorg',
    image: '/cards/2.jpg',
    nights: 1,
    days: 2,
    price: 11999,
    category: 'custom',
    route: 'Mysore → Coorg → Abbey Falls → Raja\'s Seat'
  },
  {
    id: 'custom-3',
    title: 'Wayanad Wilderness',
    description: 'Experience the pristine forests and tribal culture of Wayanad',
    image: '/cards/3.jpg',
    nights: 2,
    days: 3,
    price: 18999,
    category: 'custom',
    route: 'Mysore → Wayanad → Edakkal Caves → Chembra Peak'
  },
  {
    id: 'custom-4',
    title: 'Ooty & Coonoor Hills',
    description: 'Journey through the Nilgiri hills with toy train rides and tea gardens',
    image: '/cards/1.jpg',
    nights: 2,
    days: 3,
    price: 16999,
    category: 'custom',
    route: 'Mysore → Ooty → Coonoor → Toy Train'
  },
  {
    id: 'custom-5',
    title: 'Mysore & Ooty Heritage',
    description: 'Combine royal Mysore heritage with scenic Ooty hill station',
    image: '/cards/2.jpg',
    nights: 3,
    days: 4,
    price: 21999,
    category: 'custom',
    route: 'Mysore Palace → Ooty → Botanical Garden → Pykara'
  },
  {
    id: 'custom-6',
    title: 'Coorg & Chikmagalur Bliss',
    description: 'Twin hill station experience with coffee estates and waterfalls',
    image: '/cards/3.jpg',
    nights: 3,
    days: 4,
    price: 22999,
    category: 'custom',
    route: 'Mysore → Coorg → Chikmagalur → Mullayangiri'
  },
  {
    id: 'custom-7',
    title: 'Extended Coorg & Chikmagalur',
    description: 'Comprehensive exploration of Karnataka\'s finest hill stations',
    image: '/cards/1.jpg',
    nights: 4,
    days: 5,
    price: 27999,
    category: 'custom',
    route: 'Mysore → Coorg → Chikmagalur → Kemmangundi'
  },
  {
    id: 'custom-8',
    title: 'Chikmagalur Coffee Valley',
    description: 'Immerse in the coffee culture and scenic beauty of Chikmagalur',
    image: '/cards/2.jpg',
    nights: 2,
    days: 3,
    price: 16999,
    category: 'custom',
    route: 'Mysore → Chikmagalur → Z Point → Hebbe Falls'
  },
  {
    id: 'custom-9',
    title: 'Mysore Heritage & Culture',
    description: 'Explore the royal heritage and cultural richness of Mysore',
    image: '/cards/3.jpg',
    nights: 2,
    days: 3,
    price: 14999,
    category: 'custom',
    route: 'Mysore Palace → Chamundi Hills → Brindavan Gardens'
  },
  {
    id: 'custom-10',
    title: 'Luxury Mysore Experience',
    description: 'Premium Mysore tour with luxury accommodations and exclusive experiences',
    image: '/cards/1.jpg',
    nights: 3,
    days: 4,
    price: 29999,
    category: 'custom',
    route: 'Mysore → Luxury Stays → Heritage Sites → Premium Tours'
  },
  // Group Departures (8)
  {
    id: 'group-1',
  ...
  {
    id: 'group-2',
    title: 'Coorg Group Adventure',
    description: 'Group exploration of Coorg\'s coffee estates and natural wonders',
    image: '/cards/2.jpg',
    nights: 2,
    days: 3,
    price: 14999,
    category: 'group',
    route: 'Mysore → Coorg → Dubare → Abbey Falls'
  },
  {
    id: 'group-3',
    title: 'Wayanad Group Wilderness',
    description: 'Group adventure through Wayanad\'s forests and tribal villages',
    image: '/cards/3.jpg',
    nights: 2,
    days: 3,
    price: 16999,
    category: 'group',
    route: 'Mysore → Wayanad → Edakkal → Chembra Peak'
  },
  {
    id: 'group-4',
    title: 'Ooty Group Hill Station',
    description: 'Group hill station tour with toy train and tea garden experiences',
    image: '/cards/1.jpg',
    nights: 2,
    days: 3,
    price: 15999,
  ...
  {
    id: 'group-5',
    title: 'Chikmagalur Group Coffee Tour',
    description: 'Group coffee estate tour with trekking and waterfall experiences',
    image: '/cards/2.jpg',
    nights: 2,
    days: 3,
    price: 14999,
    category: 'group',
    route: 'Mysore → Chikmagalur → Z Point → Coffee Estates'
  },
  {
    id: 'group-6',
    title: 'Mysore-Coorg-Ooty Group Tour',
    description: 'Comprehensive group tour covering three major destinations',
    image: '/cards/3.jpg',
    nights: 5,
    days: 6,
    price: 32999,
    category: 'group',
    route: 'Mysore → Coorg → Ooty → Heritage & Hills'
  },
  {
    id: 'group-7',
    title: 'Mysore-Coorg-Wayanad Group Tour',
    description: 'Group adventure through heritage, coffee, and wilderness',
    image: '/cards/1.jpg',
    nights: 5,
    days: 6,
    price: 34999,
    category: 'group',
    route: 'Mysore → Coorg → Wayanad → Complete Experience'
  },
  {
    id: 'group-8',
    title: 'Mysore-Coorg-Chikmagalur Group Tour',
    description: 'Group tour through heritage and twin hill stations',
    image: '/cards/2.jpg',
    nights: 5,
    days: 6,
    price: 33999,
    category: 'group',
    route: 'Mysore → Coorg → Chikmagalur → Heritage & Hills'
  }
];
...
const MysoreTripOptions = React.memo(({ content }: MysoreTripOptionsProps) => {
  ...
  const tripsData = React.useMemo(() => {
    ...
    console.log('MysoreTripOptions - Content received:', content);
    
    // If no content at all, use defaults
    if (!content) {
      console.log('MysoreTripOptions - No content, using defaults');
      return mysoreTrips;
    }
    ...
    console.log('MysoreTripOptions - Has custom trips:', hasCustomTrips, 'Has group trips:', hasGroupTrips);
    
    // If neither custom nor group trips exist in CMS, use defaults
    if (!hasCustomTrips && !hasGroupTrips) {
      console.log('MysoreTripOptions - No valid trips in CMS, using defaults');
      return mysoreTrips;
    }
    
    // Combine custom and group trips from CMS, or use defaults for missing ones
    const finalCustomTrips = hasCustomTrips ? customTrips : mysoreTrips.filter(trip => trip.category === 'custom');
    const finalGroupTrips = hasGroupTrips ? groupTrips : mysoreTrips.filter(trip => trip.category === 'group');
    
    const combinedTrips = [...finalCustomTrips, ...finalGroupTrips];
    console.log('MysoreTripOptions - Final trips count:', combinedTrips.length);
          ...
          <div className="text-center mb-8 md:mb-12">
            <h2 className={cn(
              ...
              {content?.heading || (
                <>
                  How Do You Want To{' '}
                  <span className="text-[#134956]">Explore Mysore</span>?
                </>
              )}
            </h2>
            <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto">
              {content?.subheading || "Choose your perfect Mysore adventure - customize your own journey or join our group departures"}
            </p>
          </div>
        </LazyLoad>
...
MysoreTripOptions.displayName = 'MysoreTripOptions';

export default MysoreTripOptions; 