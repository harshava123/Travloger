...
const SingaporeHero = React.memo(({ content }: SingaporeHeroProps) => {
  const prefersReducedMotion = useReducedMotion();

  // WhatsApp contact function
  const handleWhatsAppClick = () => {
    const phoneNumber = '+919876543210'; // Replace with actual number
    const message = encodeURIComponent('Hi! I am interested in Singapore tour packages. Can you help me plan my trip?');
        ...
        {content?.mobileVideoUrl ? (
          ...
          >
            ...
            <Image
              ...
              alt="Singapore skyline with Marina Bay Sands and city lights"
              fill
          ...
          >
            ...
            >
              <motion.button
                ...
                aria-label="Contact us on WhatsApp to plan your Singapore trip"
              >
              ...
              <motion.button
                ...
                whileHover={prefersReducedMotion ? {} : { scale: 1.05 }}
                whileTap={prefersReducedMotion ? {} : { scale: 0.95 }}
                aria-label="View our Singapore tour packages and itineraries"
              >
...
SingaporeHero.displayName = 'SingaporeHero';
