...
interface GokarnaFAQProps {
  content?: FAQContent;
}

const defaultGokarnaFaqData: FAQType[] = [
  {
    id: '1',
    question: "What's included in the Travlogers Gokarna package?",
    answer: "Our Gokarna package includes hotel stays, daily breakfast & dinner, private cab for sightseeing, and photography. Adventure activities like kayaking, jeep safari, and boating can be added as extras. You'll also get 24/7 trip support from our team."
  },
  {
    id: '2',
    question: "Is photography included in the group trip?",
    answer: "Yes, professional photography is included in all our Gokarna group trips. Our experienced photographers will capture your best moments throughout the journey, including stunning beaches, temple visits, and adventure activities, and you'll receive a curated collection of high-quality photos after the trip."
  },
  {
    id: '3',
    question: "How does the booking process work?",
    answer: "The booking process is simple: 1) Choose your preferred Gokarna package and dates, 2) Pay a small booking amount to secure your spot, 3) Complete the remaining payment before the trip, 4) Receive your detailed itinerary and travel documents. Our team will guide you through each step."
  },
  {
    id: '4',
    question: "Will someone assist us during the trip?",
    answer: "Absolutely! You'll have a dedicated trip coordinator who will be available 24/7 throughout your Gokarna journey. Additionally, our local guides will accompany you to all major attractions and provide insights about Gokarna's culture, history, and hidden gems."
  },
  {
    id: '5',
    question: "Do you arrange adventure activities or surprises for couples?",
    answer: "Yes, we specialize in creating magical experiences in Gokarna! We can arrange adventure activities like kayaking, jeep safari, and boating. For couples, we offer romantic surprises like candlelight dinners on beaches, private temple visits, and special photography sessions at scenic locations like Om Beach and Yana Caves."
  }
];

const GokarnaFAQ = ({ content }: GokarnaFAQProps) => {
  ...
  const faqData = React.useMemo(() => {
    if (!content?.items || content.items.length === 0) {
      return defaultGokarnaFaqData;
    }
    
    // Smart merging: combine default items with CMS items
    return defaultGokarnaFaqData.map(defaultItem => {
