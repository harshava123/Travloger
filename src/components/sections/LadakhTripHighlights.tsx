...
interface LadakhTripHighlightsProps {
...
const LadakhTripHighlights = ({ content }: LadakhTripHighlightsProps) => {
        ...
        <LazyLoad animationType="fade" delay={0.2}>
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto">
              {content?.subheading || "Experience the most breathtaking destinations that make Ladakh truly magical"}
            </p>
          </div>
        </LazyLoad>
...
export default LadakhTripHighlights;