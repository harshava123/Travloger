...
interface MeghalayaHeroProps {
  content?: HeroContent;
}

const MeghalayaHero = React.memo(({ content }: MeghalayaHeroProps) => {
  const prefersReducedMotion = useReducedMotion();

  // WhatsApp contact function
  const handleWhatsAppClick = () => {
    const phoneNumber = '+919876543210'; // Replace with actual number
    const message = encodeURIComponent('Hi! I am interested in Meghalaya tour packages. Can you help me plan my trip?');
      ...
      <div className="absolute inset-0 z-0 md:hidden">
        ...
        >
          ...
          <Image
            ...
            alt="Meghalaya landscape with misty mountains and living root bridges"
            fill
          ...
          >
            ...
            >
              <motion.button
                ...
                aria-label="Contact us on WhatsApp to plan your Meghalaya trip"
              >
              ...
              <motion.button
                ...
                whileHover={prefersReducedMotion ? {} : { scale: 1.05 }}
                whileTap={prefersReducedMotion ? {} : { scale: 0.95 }}
                aria-label="View our Meghalaya tour packages and itineraries"
              >
...
MeghalayaHero.displayName = 'MeghalayaHero';

export default MeghalayaHero; 