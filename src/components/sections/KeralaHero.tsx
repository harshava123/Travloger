...
const KeralaHero = React.memo(({ content }: { content?: HeroContent }) => {
  ...
  const handleWhatsAppClick = () => {
    const phoneNumber = (content?.whatsappPhone || '+919876543210').replace(/\s+/g, '');
    const message = encodeURIComponent(content?.whatsappMessage || 'Hi! I am interested in Kerala tour packages. Can you help me plan my trip?');
          ...
          >
            ...
            >
              <motion.button
                ...
                aria-label="Contact us on WhatsApp to plan your Kerala trip"
              >
              ...
              <motion.button
                ...
                whileHover={prefersReducedMotion ? {} : { scale: 1.05 }}
                whileTap={prefersReducedMotion ? {} : { scale: 0.95 }}
                aria-label="View our Kerala tour packages and itineraries"
              >
