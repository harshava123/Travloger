...
const LadakhHero = React.memo(({ content }: LadakhHeroProps) => {
  ...
  const handleWhatsAppClick = () => {
    ...
    const message = encodeURIComponent('Hi! I am interested in Ladakh tour packages. Can you help me plan my trip?');
          ...
          >
            ...
            >
              <motion.button
                ...
                aria-label="Contact us on WhatsApp to plan your Ladakh trip"
              >
            ...
            <div className="flex flex-col items-start gap-4">
              ...
              >
                <span className="flex items-center justify-center gap-4">
                  ...
                  {content?.ctaText || "Plan on WhatsApp"}
                </span>
              </button>
              ...
              <button
                ...
                aria-label="View our Ladakh tour packages and itineraries"
              >
                <span className="flex items-center justify-center gap-4">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  {content?.ctaSecondaryText || "Get My Itinerary"}
                </span>
              </button>
            </div>
          </div>
