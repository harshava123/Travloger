...
interface MysoreHeroProps {
  content?: HeroContent;
}

const MysoreHero = React.memo(({ content }: MysoreHeroProps) => {
  const prefersReducedMotion = useReducedMotion();

  // WhatsApp contact function
  const handleWhatsAppClick = () => {
    const phoneNumber = '+919876543210'; // Replace with actual number
    const message = encodeURIComponent('Hi! I am interested in Mysore tour packages. Can you help me plan my trip?');
      ...
      <div className="absolute inset-0 z-0 md:hidden">
        ...
        >
          ...
          <Image
            ...
            alt="Mysore landscape with palaces and heritage sites"
            fill
          ...
          >
            ...
            >
              <motion.button
                ...
                aria-label="Contact us on WhatsApp to plan your Mysore trip"
              >
              ...
              <motion.button
                ...
                whileHover={prefersReducedMotion ? {} : { scale: 1.05 }}
                whileTap={prefersReducedMotion ? {} : { scale: 0.95 }}
                aria-label="View our Mysore tour packages and itineraries"
              >
