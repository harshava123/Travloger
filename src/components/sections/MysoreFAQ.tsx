...
interface MysoreFAQProps {
  content?: FAQContent;
}

const defaultMysoreFaqData: FAQType[] = [
  {
    id: '1',
    question: "What's included in the Travlogers Mysore package?",
    answer: "Our Mysore package includes hotel stays, daily breakfast & dinner, private cab for sightseeing, and photography. Heritage site visits, hill station tours, and adventure activities can be added as extras. You'll also get 24/7 trip support from our team."
  },
  {
    id: '2',
    question: "Is photography included in the group trip?",
    answer: "Yes, professional photography is included in all our Mysore group trips. Our experienced photographers will capture your best moments throughout the journey, including stunning palaces, hill stations, and cultural experiences, and you'll receive a curated collection of high-quality photos after the trip."
  },
  {
    id: '3',
    question: "How does the booking process work?",
    answer: "The booking process is simple: 1) Choose your preferred Mysore package and dates, 2) Pay a small booking amount to secure your spot, 3) Complete the remaining payment before the trip, 4) Receive your detailed itinerary and travel documents. Our team will guide you through each step."
  },
  {
    id: '4',
    question: "Will someone assist us during the trip?",
    answer: "Absolutely! You'll have a dedicated trip coordinator who will be available 24/7 throughout your Mysore journey. Additionally, our local guides will accompany you to all major attractions and provide insights about Mysore's culture, history, and hidden gems."
  },
  {
    id: '5',
    question: "Do you arrange adventure activities or surprises for couples?",
    answer: "Yes, we specialize in creating magical experiences in Mysore! We can arrange adventure activities like trekking, jeep safaris, and coffee estate tours. For couples, we offer romantic surprises like candlelight dinners at heritage sites, private palace tours, and special photography sessions at scenic locations like Chamundi Hills."
  }
];

const MysoreFAQ = ({ content }: MysoreFAQProps) => {
