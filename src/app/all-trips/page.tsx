...
const KashmirAllTripsPage = () => {
  ...
  const currentTrips = kashmirTrips.filter(trip => trip.category === activeTab);
        ...
        <div className="py-16 md:py-20">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto">
              Discover all our Kashmir adventures - from custom journeys to group departures
            </p>
          </div>
          ...
          <div className="flex justify-center mb-8">
            <div className="relative bg-white rounded-full p-1 shadow-lg border border-gray-200">
              <div className="flex">
                ...
                >
                  Custom Trip ({kashmirTrips.filter(t => t.category === 'custom').length})
                </button>
                <button
                ...
                >
                  Group Departure ({kashmirTrips.filter(t => t.category === 'group').length})
                </button>
              </div>
            </div>
          </div>
...
export default KashmirAllTripsPage; 